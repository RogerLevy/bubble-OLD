...
function: al_create_native_file_dialog ( zinitialpath ztitle zpattern -- ALLEGRO_FILECHOOSER )
function: al_show_native_file_dialog ( ALLEGRO_DISPLAY ALLEGRO_FILECHOOSER -- flag )
function: al_destroy_native_file_dialog ( dialog -- )
function: al_get_native_file_dialog_count ( dialog -- n )
function: al_get_native_file_dialog_path ( dialog n -- zaddr )
